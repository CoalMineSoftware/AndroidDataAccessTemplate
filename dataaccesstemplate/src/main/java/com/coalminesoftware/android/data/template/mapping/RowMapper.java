...
import com.coalminesoftware.android.data.template.content.ContentProviderClientTemplate;
...
public interface RowMapper<RowModel> {
	/**
	 * Used to build an object for each row in the given Cursor, without altering it with calls like
	 * {@link Cursor#moveToNext()} or {@link Cursor#close()}.
	 */
